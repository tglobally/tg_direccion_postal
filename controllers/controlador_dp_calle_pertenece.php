...
class controlador_dp_calle_pertenece extends \controllers\controlador_dp_calle_pertenece {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->titulo_lista = 'Calle Pertenece';

        $this->sidebar['lista']['titulo'] = "Calle Pertenece";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Calle Pertenece";
        ...
        $this->sidebar['modifica']['titulo'] = "Modifica Calle Pertenece";
