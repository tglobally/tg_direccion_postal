...
class controlador_dp_colonia_postal extends \controllers\controlador_dp_colonia_postal {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->titulo_lista = 'Colonias Postáles';

        $this->sidebar['lista']['titulo'] = "Colonia Postal";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Colonia Postal";
        ...
        $this->sidebar['modifica']['titulo'] = "Modifica Colonia Postal";
